...
class createpurchaseorder(models.TransientModel):
    ...
    def default_get(self, default_fields):
        ...
        if sale_order_id:
            ...
            res['booking_datetime'] = sale_order.booking_datetime
            res['customer_name'] = sale_order.partner_id.name
            res['mode_of_payment'] = sale_order.mode_of_payment.name
        update = []
    ...
    def action_create_purchase_order(self):
        ...
        purchase_order = res.create({
            ...
            'booking_datetime': str(self.booking_datetime), 
